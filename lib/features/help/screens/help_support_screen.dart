    ...
    showGlassModalBottomSheet(
      ...
      isScrollControlled: true,
        ...
        onSubmit: (title, description) async {
          ...
          final success = await SupabaseFeedbackService.instance.submitBugReport(
            userId: userId,
            title: title,
    ...
    showGlassModalBottomSheet(
      ...
      isScrollControlled: true,
        ...
        onSubmit: (title, description) async {
          ...
          final success = await SupabaseFeedbackService.instance.submitFeatureRequest(
            userId: userId,
            title: title,
            description: description,
          );
...
class _FAQCardState extends State<_FAQCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: widget.isDark ? AppColors.clayDark : AppColors.clayLight,
        borderRadius: BorderRadius.circular(16),
