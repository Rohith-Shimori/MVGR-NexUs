...
class _InterestsScreenState extends State<InterestsScreen> {
  ...
  void initState() {
    ...
    // Note: Interests are loaded from AuthProvider after first build
  }
  ...
  void didChangeDependencies() {
    ...
    if (_selectedInterests.isEmpty && authProvider.user != null) {
      _selectedInterests.addAll(authProvider.user!.interests);
    }
  }
  ...
  void _save() {
    ...
    // Update user interests via AuthProvider
    final authProvider = context.read<AuthProvider>();
    authProvider.updateProfile(interests: _selectedInterests.toList());
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: isSelected
                    ? []
                    : (isDark ? ClayShadows.dark(intensity: 0.4) : ClayShadows.light(intensity: 0.4)),
              ),
              child: Row(
