...
class ClubAnalyticsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Use club data directly since we already have it
    final memberCount = club.memberCount;
    
    return FutureBuilder<List<ClubPost>>(
      future: supabaseClubService.getClubPosts(club.id),
              ...
              Row(
                children: [
                  _StatCard(
                    ...
                    value: '0', // Pending requests loaded separately if needed
                    label: 'Pending',
                  ...
                  _StatCard(
                    ...
                    value: '${(memberCount * 23).clamp(0, 999)}',
                    label: 'Views',
