...
class FacultyDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isFaculty = user?.role.isFaculty ?? false;
    ...
    return Consumer<SupabaseClubService>(
      builder: (context, clubService, _) {
        return Scaffold(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      _StatCard(
                        icon: Icons.groups,
                        value: '${clubService.clubs.length}',
                        label: 'Clubs',
    ...
    showGlassModalBottomSheet(
      ...
      isScrollControlled: true,
        ...
        builder: (context, scrollController) => Container(
          ...
          child: Consumer4<SupabaseClubService, SupabaseEventService, SupabaseForumService, SupabaseAnnouncementService>(
            builder: (context, clubService, eventService, forumService, announcementService, _) {
              final allEvents = eventService.events;
              final allClubs = clubService.clubs;
              final allQuestions = forumService.questions;
              final allAnnouncements = announcementService.announcements;
