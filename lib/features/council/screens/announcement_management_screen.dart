...
class AnnouncementManagementScreen extends StatelessWidget {
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _AnnouncementCard(
                      ...
                      onDelete: () => _deleteAnnouncement(context, announcement, announcementService),
                    );
                  },
                ),
  ...
  void _deleteAnnouncement(BuildContext context, Announcement announcement, SupabaseAnnouncementService service) {
    showDialog(
      context: context,
