...
class AppColors {
  ...
  // ============ LIQUID GLASS COLORS ============
  static const Color liquidGlassBase = Color(0x20FFFFFF);
  static const Color liquidGlassBorder = Color(0x40FFFFFF);
  static const Color liquidGlassHighlight = Color(0x60FFFFFF);
  static const Color liquidGlassGlow = Color(0xFF6366F1);
  static const Color liquidGlassBaseDark = Color(0x15FFFFFF);
  static const Color liquidGlassBorderDark = Color(0x25FFFFFF);
  
  // ============ CLAYMORPHIC COLORS ============
  // More distinctive clay colors for visible depth effect
  static const Color clayLight = Color(0xFFEEF2F6); // Slightly darker than background for visible cards
  static const Color clayDark = Color(0xFF252B3D);  // Brighter than card for elevated feel
  static Color clayInnerShadowLight = Colors.black.withValues(alpha: 0.12);
  static Color clayInnerShadowDark = Colors.black.withValues(alpha: 0.35);
  static Color clayOuterShadowLight = Colors.white.withValues(alpha: 1.0);
  static const Color clayOuterShadowDark = Color(0xFF2E3548);
  
  // ============ LIQUID GLASS GRADIENTS ============
  static const List<Color> liquidGlassGradient = [
    Color(0x30FFFFFF),
    Color(0x15FFFFFF),
    Color(0x08FFFFFF),
  ];
  
  static const List<Color> liquidGlassGradientDark = [
    Color(0x18FFFFFF),
    Color(0x0AFFFFFF),
    Color(0x05FFFFFF),
  ];
  ...
  static const List<Color> auroraGradientSubtle = [
    Color(0x406366F1),
    Color(0x408B5CF6),
    Color(0x4006B6D4),
  ];
...
/// Claymorphic Shadows - Soft 3D pillowy effect
class ClayShadows {
  // Stronger shadows for more visible 3D effect
  static List<BoxShadow> light({double intensity = 1.0}) => [
    BoxShadow(
      color: Colors.white.withValues(alpha: 1.0 * intensity),
  ...
  static List<BoxShadow> dark({double intensity = 1.0}) => [
    BoxShadow(
      color: const Color(0xFF303850).withValues(alpha: 0.8 * intensity),
  ...
  /// Pressed state (inverted shadows for "pressed in" effect)
  static List<BoxShadow> pressed(bool isDark) => isDark
      ? [
          ...
          BoxShadow(
            color: const Color(0xFF252B3B).withValues(alpha: 0.3),
            offset: const Offset(-2, -2),
            blurRadius: 6,
          ),
        ]
...
/// Skeuomorphic Shadows - Raised tactile effect
class SkeuoShadows {
  static List<BoxShadow> raised(Color baseColor, {double elevation = 1.0}) => [
    BoxShadow(
      color: baseColor.withValues(alpha: 0.25 * elevation),
      offset: Offset(0, 4 * elevation),
      blurRadius: 12 * elevation,
    ),
    BoxShadow(
      color: Colors.black.withValues(alpha: 0.12 * elevation),
      offset: Offset(0, 8 * elevation),
      blurRadius: 20 * elevation,
    ),
  ];
  
  static List<BoxShadow> floating(Color baseColor) => [
    BoxShadow(
...
/// Liquid Glass Animation Curves - Fluid motion
class LiquidCurves {
  static const Curve flow = Cubic(0.4, 0.0, 0.2, 1.0);
  static const Curve ripple = Curves.easeOutBack;
  static const Curve morph = Cubic(0.65, 0.0, 0.35, 1.0);
  static const Curve elastic = Cubic(0.68, -0.55, 0.265, 1.55);
