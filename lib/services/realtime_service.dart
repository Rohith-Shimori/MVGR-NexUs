...
class RealtimeService {
  ...
  Future<void> initialize() async {
    ...
    if (!SupabaseConfig.isInitialized) {
      AppLogger.warning(' Supabase not initialized, skipping realtime');
      return;
    }

    AppLogger.info(' Initializing Supabase Realtime...');
    _isInitialized = true;
  }
  ...
  RealtimeChannel subscribeToClubs({
    ...
    final channel = SupabaseConfig.client
        ...
        .onPostgresChanges(
          ...
          table: 'clubs',
          callback: (payload) {
            AppLogger.info(' Club change: ${payload.eventType}');
            if (onChange != null) {
              ...
              try {
                ...
                AppLogger.error(' Error parsing club: $e');
              }
            }
          },
        )
    ...
    AppLogger.info(' Subscribed to clubs channel');
    return channel;
  }
  ...
  RealtimeChannel subscribeToEvents({
    ...
    final channel = SupabaseConfig.client
        ...
        .onPostgresChanges(
          ...
          table: 'events',
          callback: (payload) {
            AppLogger.info(' Event change: ${payload.eventType}');
            if (onChange != null) {
              final type = _mapEventType(payload.eventType);
              final data = payload.newRecord.isNotEmpty 
                  ? payload.newRecord 
              ...
              try {
                ...
                AppLogger.error(' Error parsing event: $e');
              }
            }
          },
        )
    ...
    _channels.add(channel);
    AppLogger.info(' Subscribed to events channel');
    return channel;
  }
  ...
  RealtimeChannel subscribeToAnnouncements({
    ...
    final channel = SupabaseConfig.client
        ...
        .onPostgresChanges(
          ...
          table: 'announcements',
          callback: (payload) {
            AppLogger.info(' Announcement change: ${payload.eventType}');
            if (onChange != null) {
              final type = _mapEventType(payload.eventType);
              final data = payload.newRecord.isNotEmpty 
                  ? payload.newRecord 
    ...
    _channels.add(channel);
    AppLogger.info(' Subscribed to announcements channel');
    return channel;
  }
  ...
  RealtimeChannel subscribeToClubPosts({
    ...
    final channel = SupabaseConfig.client
        ...
        .onPostgresChanges(
          ...
          callback: (payload) {
            AppLogger.info(' Club post change in $clubId');
            if (onChange != null) {
              final type = _mapEventType(payload.eventType);
              final data = payload.newRecord.isNotEmpty 
                  ? payload.newRecord 
  ...
  RealtimeChannel subscribeToEventRsvps({
    ...
    final channel = SupabaseConfig.client
        ...
        .onPostgresChanges(
          ...
          callback: (payload) {
            AppLogger.info(' RSVP change for event $eventId');
            if (onChange != null) {
              final type = _mapEventType(payload.eventType);
              final data = payload.newRecord.isNotEmpty 
                  ? payload.newRecord 
