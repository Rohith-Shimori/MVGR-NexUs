...
class NotificationService extends ChangeNotifier {
  ...
  Future<void> initializeRealtime() async {
    ...
    AppLogger.info(' Initializing NotificationService realtime...');
    ...
    _isSubscribed = true;
    AppLogger.success(' NotificationService realtime subscribed');
  }

  /// Cleanup realtime subscriptions
  Future<void> disposeRealtime() async {
    await _announcementChannel?.unsubscribe();
    await _eventChannel?.unsubscribe();
    await _clubChannel?.unsubscribe();
    _isSubscribed = false;
    AppLogger.info(' NotificationService realtime unsubscribed');
  }
